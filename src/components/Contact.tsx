...
export default component$(() => {
  ...
  return (
    <section class="py-12 md:py-20 bg-linear-to-b from-gray-50 to-white dark:from-slate-900 dark:to-slate-800 transition-colors duration-300" id="contact">
      <div class="max-w-6xl mx-auto px-4 md:px-8">
        <h2 class="contact-title opacity-0 text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-12 md:mb-16 bg-clip-text text-transparent bg-linear-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
          Get In Touch
        </h2>
          ...
          <div class="order-2 lg:order-1">
            ...
            <div class="mt-8 md:mt-12">
              ...
              <div class="flex space-x-4 md:space-x-6">
                <a href="https://linkedin.com/in/mhfed" target="_blank" rel="noopener noreferrer" class="contact-item opacity-0 w-10 h-10 md:w-12 md:h-12 bg-linear-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 transition-all duration-300">
                  <svg class="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                </a>
                <a href="https://github.com/mhfed" target="_blank" rel="noopener noreferrer" class="contact-item opacity-0 w-10 h-10 md:w-12 md:h-12 bg-linear-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 transition-all duration-300">
                  <svg class="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div class="space-y-4 md:space-y-6">
                ...
                <button
                  ...
                  class={`w-full bg-linear-to-r from-blue-600 to-purple-600 dark:from-blue-500 dark:to-purple-500 text-white py-3 md:py-4 rounded-lg transition-all duration-300 text-sm md:text-base font-medium shadow-lg ${
