          ...
          <div>
            ...
            <div class="space-y-6">
              <div class="contact-item opacity-0 flex items-center group">
                ...
                <span class="text-gray-700 text-lg">San Francisco, CA</span>
              </div>
              <div class="contact-item opacity-0 flex items-center group">
                <span class="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mr-4 text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                  📧
                </span>
                <a href="mailto:your.email@example.com" class="text-gray-700 text-lg hover:text-blue-600 transition-colors duration-300">
              ...
              <div class="contact-item opacity-0 flex items-center group">
                ...
                <a href="tel:+1234567890" class="text-gray-700 text-lg hover:text-blue-600 transition-colors duration-300">
                  +1 (234) 567-890
                </a>
              </div>
            </div>
            <div class="mt-12">
              ...
              <div class="flex space-x-6">
                <a href="#" class="contact-item opacity-0 w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 transition-all duration-300">
