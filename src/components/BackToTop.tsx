...
export const BackToTop = component$(() => {
  ...
  return (
    <button
      onClick$={scrollToTop}
      class={`cursor-pointer fixed bottom-8 right-8 z-40 w-14 h-14 bg-linear-to-br from-blue-600 via-purple-600 to-blue-700 dark:from-blue-500 dark:via-purple-500 dark:to-blue-600 text-white rounded-2xl shadow-xl dark:shadow-slate-900/50 hover:shadow-2xl transition-all duration-500 hover:scale-110 active:scale-95 group border border-white/20 dark:border-slate-600/30 backdrop-blur-sm ${
        isVisible.value 
